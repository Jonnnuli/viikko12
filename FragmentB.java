...
public class FragmentB extends Fragment {
    ...
    private EditText newPurchase;
    private EditText toRemember;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newPurchase = view.findViewById(R.id.editTextPurchase);
        toRemember = view.findViewById(R.id.editTextToRemember);
        ...
        buttonOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (remember.equals("")) {
                    ...
                    Toast.makeText(getContext(), "Lisäsit tuotteen!", Toast.LENGTH_SHORT).show();
                }
                else {
